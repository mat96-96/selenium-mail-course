...
namespace EndToEndMailCourse._02
{
    ...
    public class Workshop02Tests
    {
        ...
        public void ShouldTestWorkshop2Page()
        {
            ...
            IWebElement commentInput,
                nameInput,
                showDetails;

            nameInput = driver.FindElement(By.Id("taskNameInput"));
            nameInput.SendKeys(name);

            showDetails = driver.FindElement(By.Id("showDetailsButton"));
            showDetails.Click();

            commentInput = driver.FindElement(By.Id("commentInput"));
