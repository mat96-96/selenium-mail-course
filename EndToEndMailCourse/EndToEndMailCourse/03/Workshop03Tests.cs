...
namespace EndToEndMailCourse._03
{
    ...
    public class Workshop03Tests
    {
        ...
        public void ShouldCheckSelectedBookName()
        {
            ...
            #region 
            book = driver.FindElement(By.CssSelector(".list-group-item.book.selected > h4"));
        ...
        public void ShouldCheckNumberOfBooks()
        {
            ...
            #region
            books = driver.FindElements(By.CssSelector(".books > ul > li.list-group-item.book"));
        ...
        public void ShouldCheckLinksDomain()
        {
            ...
            #region 
            links = driver.FindElements(By.CssSelector(".books > ul > li.list-group-item.book > h4 > a.btn"));
